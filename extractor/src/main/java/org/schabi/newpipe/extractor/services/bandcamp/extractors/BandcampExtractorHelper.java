...
public final class BandcampExtractorHelper {
    ...
    private static final List<ImageSuffix> IMAGE_URL_SUFFIXES_AND_RESOLUTIONS = List.of(
            ...
            // 180 returns the same image aspect ratio and size
            ...
            // 203 returns the same image aspect ratio and size
     ...
     */
    @Nonnull
    public static List<Image> getImagesFromImageUrl(final String imageUrl) {
